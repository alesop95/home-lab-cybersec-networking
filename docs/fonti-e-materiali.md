...
Da qui discende un registro dedicato, [Fonti web consultate, per sessione](fonti-web-consultate.md), che annota per ogni fonte esterna consultata l'indirizzo, la data, il grado di affidabilita' e l'affermazione che sostiene. L'ancoraggio di cui parla il paragrafo precedente diventa cosi' consultabile invece che implicito, e restano distinte tre cose che mescolate si annullano: la documentazione ufficiale di un produttore, la segnalazione convergente di una comunita' e il listino di un rivenditore.
